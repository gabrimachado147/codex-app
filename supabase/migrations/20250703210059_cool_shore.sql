/*
  ...
  1. Enum Types
    ...
    - content_type (post, carousel, video, story) 
    - content_status (draft, pending_approval, approved, rejected, published)

  2. Tables
    - contents: Main content table with media, tags, status
    - content_analytics: Track content interactions and events
    - ai_suggestions: Store AI-generated content suggestions
    - scheduled_posts: Manage scheduled content publishing
    - content_comments: Threaded comments on content
